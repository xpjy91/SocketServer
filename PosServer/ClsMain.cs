        ...
        public Dictionary<string, string> SearchTran(string sStoreNo, string sSaleDate, string sPosNo, string sTranNo)
        {
            ...
            try
            {
                ...
                while (sqlRead.Read() == true)
                {
                    ...
                    dicTranLog["sSaleDate"] = sqlRead["sSaleDate"].ToString();
                    dicTranLog["sPosNo"] = sqlRead["sPosNo"].ToString();
                    dicTranLog["sTranNo"] = sqlRead["sTranNo"].ToString();
                    dicTranLog["sSysDate"] = sqlRead["sSysDate"].ToString();
                    dicTranLog["sSaleTime"] = sqlRead["sSaleTime"].ToString();
                    dicTranLog["sTrData"] = sqlRead["sTrData"].ToString();
                    dicTranLog["sTranType"] = sqlRead["sTranType"].ToString();
                    dicTranLog["sTranKind"] = sqlRead["sTranKind"].ToString();
                    dicTranLog["sCashierNo"] = sqlRead["sCashierNo"].ToString();
                    dicTranLog["sOrgSaleDate"] = sqlRead["sOrgSaleDate"].ToString();
                    dicTranLog["sOrgPosNo"] = sqlRead["sOrgPosNo"].ToString();
                    dicTranLog["sOrgTranNo"] = sqlRead["sOrgTranNo"].ToString();
                    dicTranLog["sOrgCashierNo"] = sqlRead["sOrgCashierNo"].ToString();
                    dicTranLog["sItemCnt"] = sqlRead["sItemCnt"].ToString();
                    dicTranLog["sTotAmt"] = sqlRead["sTotAmt"].ToString();
                    dicTranLog["sDisAmt"] = sqlRead["sDisAmt"].ToString();
                    dicTranLog["sCutAmt"] = sqlRead["sCutAmt"].ToString();
                    dicTranLog["sCashAmt"] = sqlRead["sCashAmt"].ToString();
                    dicTranLog["sCardAmt"] = sqlRead["sCardAmt"].ToString();
                    dicTranLog["sCpnAmt"] = sqlRead["sCpnAmt"].ToString();
                    dicTranLog["sGiftAmt"] = sqlRead["sGiftAmt"].ToString();
                    dicTranLog["sCashFlag"] = sqlRead["sCashFlag"].ToString();
                    dicTranLog["sGcFlag"] = sqlRead["sGcFlag"].ToString();
                    dicTranLog["sPpFlag"] = sqlRead["sPpFlag"].ToString();
                    dicTranLog["sCouponFlag"] = sqlRead["sCouponFlag"].ToString();
                    dicTranLog["sCardFlag"] = sqlRead["sCardFlag"].ToString();
                    dicTranLog["sDbFlag"] = sqlRead["sDbFlag"].ToString();
                    dicTranLog["sPointFlag"] = sqlRead["sPointFlag"].ToString();
                    dicTranLog["sHalbuFlag"] = sqlRead["sHalbuFlag"].ToString();
                    dicTranLog["sRetFlag"] = sqlRead["sRetFlag"].ToString();
                    dicTranLog["sCustSex"] = sqlRead["sCustSex"].ToString();
                    dicTranLog["sCustAge"] = sqlRead["sCustAge"].ToString();
